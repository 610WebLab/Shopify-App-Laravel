...
class CountriesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // foreach ($country as $key1 => $cont) {
        //     // echo $key1."=>".$cont->state_code;
        //     $table_rate = DB::table('shipping_tax_rates')->select('tax_rate_id', 'tax_rate_state')->get();
        //     foreach ($table_rate as $value) {
        //         $locations = DB::table('shipping_tax_rate_locations')->select('tax_rate_id', 'location_code', 'location_type')
        //             ->where('tax_rate_id', $value->tax_rate_id)
        //             ->get();


        //         $data = [];
        //         if (count($locations) == 2) {
        //             $data['state'] = $value->tax_rate_state;
        //             $data['city'] = $locations[1]->location_code;
        //             $data['zip_code'] = $locations[0]->location_code;
        //             ShippingZoneLocation::insert($data);
        //         }
        //     }
        // }

        // $locationData  = DB::table('shipping_tax_rates')
        // ->select('shipping_tax_rates.tax_rate_state', 'shipping_tax_rate_locations.location_type', 'shipping_tax_rate_locations.*')
        // ->join('shipping_tax_rate_locations', 'shipping_tax_rates.tax_rate_id', '=', 'shipping_tax_rate_locations.tax_rate_id')
        // ->groupBy('shipping_tax_rate_locations.tax_rate_id')
        // ->get();

        // return $locationData->toArray();

        // foreach($locationData as $key => $element) {
        //    return $element;
        ...
        // foreach ($countries as $contryKey => $country) {
        //     // echo $key ." ==> ". $country."<br/>";
        //     if (array_key_exists($contryKey, $states)) {
        //         echo $contryKey . " = " . $country . "<br/>";
        //         $saveData = [
        //             'country_name' => $country,
        //             'country_code' => $contryKey,
        //             'state_name' => "",
        //             'state_code' => "",
        //         ];
                
        //         Countries::insert($saveData);

        //         foreach ($states as $stateKey => $state) {
        //             if ($contryKey == $stateKey) {
        //                 // if (empty($state)) {
        //                 //     $saveData = [
        //                 //         'country_name' => $country,
        //                 //         'country_code' => $contryKey,
    ...
    public function getCountryAndState(Request $request)
    {
        if (!empty($request->country_code)) {
            // $state = Countries::all()->where('country_code', $request->country_code)->groupBy('country_code');
            // $country = Countries::all()->groupBy('country_code');
            // $result = [
            //     'status' => 1,
            //     'country' => $country->toArray(),
            //     'state' => $state
            ...
            foreach ($country as $key => $value) {;
                foreach ($value as $index => $element) {
                    if ($element['country_code'] == $request->country_code) {
                        $countryCode[$element['country_code']][$element['country_name']][]  = [
